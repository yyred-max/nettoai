                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 flex items-center gap-1.5 text-sm text-muted">
                                        <i className="bi bi-geo-alt" />No transaction was executed.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 rounded-lg border border-border bg-bg-panel/40 p-5">
                            ...
                            <div className="mt-4 rounded-md border-l-2 border-rose-500 bg-rose-950/30 px-4 py-3">
                                <p className="text-sm text-gray-100">
                                    {data.reasons?.join("; ") || "Policy violation detected."}
                                </p>
                            </div>
                        </div>

                        {/* Provenance table (BLOCKED) */}
                        <div className="mt-6 rounded-lg border border-border bg-bg-panel/40 p-5">
                                        ...
                                        {Object.entries(data.provenance || {})
                                            ...
                                            .map(([field, status]) => {
                                                ...
                                                return (
                                                    <tr
                                                        key={field}
                                                        className={`border-b border-border/60 ${statusStr !== "verified"
                                                                ? "border-l-2 border-l-rose-500 bg-rose-950/10"
                                                                : ""
                                                            }`}
                                                    >
                                                        <td className="px-4 py-4 font-mono text-sm font-semibold text-gray-100 capitalize">
                                                            {field}
                                                        </td>
                                ...
                                <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-stretch">
                                    ...
                                    <div className="flex-1 rounded-md border border-accent bg-accent/5 px-4 py-3">
                                        ...
                                        <p className="mt-2 font-mono text-sm text-gray-100">
                                            transfer({data.action?.recipient || "—"}, {data.action?.amount || "—"} {data.action?.token || "USDT"})
                                        </p>
                                    </div>
                                </div>
                            </div>
