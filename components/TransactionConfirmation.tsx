            ...
            <div className="w-full max-w-2xl rounded-lg border border-border p-8">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                    <div className="relative rounded-md border border-accent bg-bg-panel/40 px-4 py-3">
                        ...
                        <span className="absolute -right-4 top-1/2 hidden -translate-y-1/2 text-muted sm:block">
                    ...
                    <div className="rounded-md border-t-2 border-accent bg-bg-panel/40 px-4 py-3">
                        ...
                        <p className="mt-1 font-display text-2xl font-extrabold text-accent">
                            {amount}{" "}
                            <span className="font-mono text-base font-normal text-gray-200">
                                {token}
                            </span>
                        </p>
                    </div>
                    <div className="rounded-md border border-border bg-bg-panel/40 px-4 py-3">
                        ...
                        <p className="mt-1 flex items-center gap-2 font-mono text-sm text-gray-100">
                ...
                <div className="mt-6 rounded-md bg-bg-panel/60 p-5">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        ...
                        <div className="text-right">
                            ...
                            <p className="mt-1 rounded bg-bg px-2 py-1 font-mono text-xs text-gray-300">
                                {decisionId}
                            </p>
                        </div>
                    </div>
                ...
                <div className="mt-8 flex items-center justify-end gap-3">
                    <button
                        type="button"
                        onClick={onCancel}
                        className="rounded-md border border-border px-6 py-3 font-mono text-xs text-gray-300 transition-colors hover:border-accent hover:text-accent"
                    >
                        CANCEL
                    </button>
                    <button
                        ...
                        className="flex items-center gap-2 rounded-md bg-accent px-6 py-3 font-mono text-xs font-bold text-bg transition-colors hover:bg-accent/90"
                    >
